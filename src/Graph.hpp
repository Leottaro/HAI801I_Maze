...
public:
            ...
            for (float j = 0; j < _n; j++) {
                for (float k = 0; k < _n; k++){
                    ...
                    if(k != 0){
                        ...
                        G.m_neighbours[v0].push_back(v3);
                        G.m_neighbours[v3].push_back(v0);
                    }
                }
            }
        }
    ...
    static Graph circleGraph(float _nbCercles, float _n) {
        ...
        for (float j = 0; j < _n; j++) {
            size_t v0 = j + 1;
            G.m_neighbours[v0].push_back(0);
            G.m_neighbours[0].push_back(v0);
        ...
        G.m_neighbours[_n + 1].push_back(1);
        G.m_neighbours[1].push_back(_n + 1);
